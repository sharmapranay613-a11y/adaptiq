...
export default function AnalysisPage() {
  ...
  useEffect(() => {
    const savedScore = localStorage.getItem('learnova_diagnostic_score')
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="glass p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Classifying errors reveals the fix — conceptual gaps need teaching, careless ones need pacing.
          </p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1.5 text-sm leading-relaxed text-foreground/90 text-pretty">
              {score < 50
                ? `Your score is ${score}%, which indicates a weak foundation. Focus on Java Inheritance concepts before moving to advanced practice.`
                : score <= 75
                  ? `Your score is ${score}%. You have a developing understanding. Focus on revision and targeted practice to strengthen your weak areas.`
                  : `Your score is ${score}%. You have a strong foundation. Use challenge questions to maintain and deepen your understanding.`}
            </p>
